    ...
    <div className="min-h-screen bg-paper">
      <header className="border-b border-stone bg-white">
        <div className="mx-auto flex max-w-4xl items-center justify-between px-6 py-5">
          <div>
            <p className="text-[10px] uppercase tracking-[0.3em] text-navy">Installation</p>
            <h1 className="font-serif text-xl">Serveur & déploiement</h1>
          </div>
          <a href="#/admin" className="rounded border border-stone px-4 py-2 text-[11px] uppercase tracking-[0.15em] hover:bg-stone/40">
            ← Administration
          </a>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-4xl space-y-6 px-6 py-10">
        <Card>
          ...
          {msg && <p className="mt-4 text-sm text-navy">{msg}</p>}
        </Card>

        <Card>
          <h2 className="font-serif text-2xl">Démarrage rapide</h2>
          <pre className="mt-4 overflow-auto rounded bg-ink p-4 text-[12px] leading-relaxed text-stone">{`# 1 — construire le site
...
npm start        →  http://localhost:4000`}</pre>
        ...
        <Card>
          <h2 className="font-serif text-2xl">Notice complète de déploiement</h2>
          <pre className="mt-4 max-h-80 overflow-auto rounded bg-stone/30 p-4 text-[11px] leading-relaxed text-ink/80">{INSTALL_DOC}</pre>
          <div className="mt-4">
        ...
        <Card>
          <h2 className="font-serif text-2xl">Ce que contient le backend</h2>
